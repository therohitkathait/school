	  ...
	  if(mysqli_num_rows($result)>0){
			...
			while($row=mysqli_fetch_assoc($result))
			{
				...
				<tr>
						...
						<td scope="col">
				<a target="_blank" href="add_marksheet.php?stid='.$row['id'].'" > <i class="fa fa-plus"></i></a> 

				<a href="test.php?stid='.$row['id'].'"  class="idcard btn btn-info btn-lg" title="Print Marksheet"> <i class="fa-solid fa-medal"></i></a> 
				
				<a href="idcard.php?stid='.$row['id'].'"  class="idcard btn btn-info btn-lg" title="Idcard"> <i class="fa fa-user"></i></a>
						</td>
						</tr>';
					$i++;
			}
